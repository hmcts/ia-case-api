...
./bin/utils/system-user-role-assignment.sh "${IA_SYSTEM_USERNAME}" "${IA_SYSTEM_PASSWORD}" "iac-system-users" "iac-hearing-system-user" "hearing-manager"
./bin/utils/system-user-case-allocator-assignment.sh "${IA_SYSTEM_USERNAME}" "${IA_SYSTEM_PASSWORD}"
