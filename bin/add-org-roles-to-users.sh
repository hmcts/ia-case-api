...
./bin/utils/organisational-role-assignment.sh "${IA_SYSTEM_USERNAME}" "${IA_SYSTEM_PASSWORD}" "PUBLIC" "hearing-viewer" '{"jurisdiction":"IA", "caseType": "Asylum"}' "SYSTEM" "iac-system-users" "iac-hearings-system-user"
./bin/utils/organisational-role-assignment.sh "${IA_SYSTEM_USERNAME}" "${IA_SYSTEM_PASSWORD}" "PUBLIC" "hearing-manager" '{"jurisdiction":"IA", "caseType": "Asylum"}' "SYSTEM" "iac-system-users" "iac-hearings-system-user"
