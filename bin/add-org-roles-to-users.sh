...
./bin/utils/organisational-role-assignment.sh "${IA_SYSTEM_UPDATE_USERNAME}" "${IA_SYSTEM_UPDATE_PASSWORD}" "PUBLIC" "case-allocator" '{"jurisdiction":"IA","primaryLocation":"765324"}' "SYSTEM"
