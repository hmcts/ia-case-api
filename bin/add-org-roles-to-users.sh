...
./bin/utils/organisational-role-assignment.sh "${IA_WA_ADMINOFFICER_USERNAME}" "${IA_WA_ADMINOFFICER_PASSWORD}" "PRIVATE" "hmcts-admin" '{"jurisdiction":"IA","primaryLocation":"765324","substantive":"N"}' "ADMIN" "BASIC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_CTSC_ADMIN_USERNAME}" "${IA_WA_CTSC_ADMIN_PASSWORD}" "PRIVATE" "hmcts-ctsc" '{"jurisdiction":"IA","primaryLocation":"765324","substantive":"N"}' "CTSC" "BASIC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_ADMINOFFICER_USERNAME_1}" "${IA_WA_ADMINOFFICER_PASSWORD_1}" "PRIVATE" "hmcts-admin" '{"jurisdiction":"IA","primaryLocation":"765324","substantive":"N"}' "ADMIN" "BASIC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_CTSC_ADMIN_USERNAME_2}" "${IA_WA_CTSC_ADMIN_PASSWORD_2}" "PRIVATE" "hmcts-ctsc" '{"jurisdiction":"IA","primaryLocation":"765324","substantive":"N"}' "CTSC" "BASIC"
