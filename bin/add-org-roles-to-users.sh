...
./bin/utils/organisational-role-assignment.sh "${IA_WA_ADMINOFFICER_USERNAME}" "${IA_WA_ADMINOFFICER_PASSWORD}" "PRIVATE" "hmcts-admin" '{"jurisdiction":"IA","primaryLocation":"765324","substantive": "N"}' "ADMIN"

./bin/utils/organisational-role-assignment.sh "${IA_WA_CTSC_ADMIN_USERNAME}" "${IA_WA_CTSC_ADMIN_PASSWORD}" "PUBLIC" "ctsc" '{"jurisdiction":"IA","primaryLocation":"765324","workTypes":"hearing_work,upper_tribunal,routine_work,stf_24w_hearing_work,stf_24w_upper_tribunal,stf_24w_routine_work,queries,queries_stf"}' "CTSC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_CTSC_ADMIN_USERNAME}" "${IA_WA_CTSC_ADMIN_PASSWORD}" "PRIVATE" "hmcts-ctsc" '{"jurisdiction":"IA","primaryLocation":"765324","substantive": "N"}' "CTSC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_ADMINOFFICER_USERNAME_1}" "${IA_WA_ADMINOFFICER_PASSWORD_1}" "PRIVATE" "hmcts-admin" '{"jurisdiction":"IA","primaryLocation":"765324","substantive": "N"}' "ADMIN"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_CTSC_ADMIN_USERNAME_2}" "${IA_WA_CTSC_ADMIN_PASSWORD_2}" "PRIVATE" "hmcts-ctsc" '{"jurisdiction":"IA","primaryLocation":"765324","substantive": "N"}' "CTSC"
...
./bin/utils/organisational-role-assignment.sh "${IA_WA_ADMINOFFICER_NO_IDAM_USERNAME}" "${IA_WA_ADMINOFFICER_NO_IDAM_PASSWORD}" "PRIVATE" "hmcts-admin" '{"jurisdiction":"IA","primaryLocation":"765324","substantive": "N"}' "ADMIN"
