...
echo 'export ENVIRONMENT=hearings preview'
...
echo "export CCD_DEFINITION_STORE_API_BASE_URL=https://ccd-definition-store-ia-case-api-aat.preview.platform.hmcts.net"