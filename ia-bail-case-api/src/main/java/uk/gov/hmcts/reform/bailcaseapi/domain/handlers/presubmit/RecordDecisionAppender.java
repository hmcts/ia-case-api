...
public class RecordDecisionAppender implements PreSubmitCallbackHandler<BailCase> {
    ...
    public PreSubmitCallbackResponse<BailCase> handle(PreSubmitCallbackStage callbackStage,
        ...
        String conditionAppearance = """
                The applicant is to appear before an Immigration Officer at [location] between\
        ...
        String conditionActivities = """
                The Applicant shall not undertake the activities listed below while on\
                 immigration bail without further order:
                
                The Applicant is not allowed to work
                
                The Applicant is not allowed to study""";
        String conditionResidence = """
                The applicant must reside at ADDRESS.
        ...
        String conditionReporting = "The Applicant must report to an Immigration Officer at [ADDRESS, TIME, DATE"
                + " AND FREQUENCY].";
        String conditionElectronicMonitoring = """
                Note: Where the Tribunal has directed that the Applicant should be\
        ...
        String bailTransferDirections = """
                The Tribunal directs that on commencement of bail future management including\
