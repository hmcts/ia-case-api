...
public class CcdMock {
    ...
    public static final String retrieveCasesUrl = "/caseworkers/1/jurisdictions/IA/case-types/Asylum/cases" + getQueryString();
    public static final String paginationMetadataUrl = "/caseworkers/1/jurisdictions/IA/case-types/Asylum/cases/pagination_metadata" + getQueryString();
