...
class RemoveStatutoryTimeframe24WeeksTest extends SpringBootIntegrationTest implements WithUserDetailsStub,
    ...
    void removes_a_statutory_timeframe_24_weeks() {
        ...
        String homeOfficeCohort = "some cohort";
        PreSubmitCallbackResponseForTest response = iaCaseApiClient.aboutToSubmit(callback()
                ...
                .caseDetails(someCaseDetailsWith()
                        ...
                        .caseData(anAsylumCase()
                                ...
                                .with(STF_24W_HOME_OFFICE_COHORT, homeOfficeCohort)
        ...
        assertThat(caseNote.getCaseNoteSubject()).isEqualTo("Setting statutory timeframe 24 weeks to " + homeOfficeCohort + " - No");
        ...
        assertThat(statutoryTimeframe24Weeks.get().getCurrentHomeOfficeCohortAutoGenerated()).isEqualTo(homeOfficeCohort);
        ...
        assertThat(statutoryTimeframe24WeekHistory.get(0).getValue().getHomeOfficeCohort()).isEqualTo(homeOfficeCohort);
        assertThat(response.getAsylumCase().read(XUI_BANNER_TEXT).get()).isEqualTo("some text");
        assertThat(response.getAsylumCase().read(STF_24W_HOME_OFFICE_COHORT).get()).isEqualTo(homeOfficeCohort);
        assertThat(response.getAsylumCase().read(STF_24W_CURRENT_STATUS_AUTO_GENERATED).get()).isEqualTo(YesOrNo.NO.toString());
    }
}
