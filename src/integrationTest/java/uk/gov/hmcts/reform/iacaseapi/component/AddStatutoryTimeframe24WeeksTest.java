...
class AddStatutoryTimeframe24WeeksTest extends SpringBootIntegrationTest implements WithUserDetailsStub,
    ...
    public static final String SOME_HOME_OFFICE_COHORT = "some-cohort";
    ...
    void adds_a_statutory_timeframe_24_weeks() {
        ...
        PreSubmitCallbackResponseForTest response = iaCaseApiClient.aboutToSubmit(callback()
                ...
                .caseDetails(someCaseDetailsWith()
                        ...
                        .caseData(anAsylumCase()
                                ...
                                .with(STF_24W_HOME_OFFICE_COHORT, SOME_HOME_OFFICE_COHORT)
        ...
        assertThat(caseNote.getCaseNoteSubject()).isEqualTo("Setting statutory timeframe 24 weeks to " + SOME_HOME_OFFICE_COHORT + " - Yes");
        ...
        assertThat(statutoryTimeframe24Weeks.get().getCurrentHomeOfficeCohortAutoGenerated()).isEqualTo(SOME_HOME_OFFICE_COHORT);
        ...
        assertThat(statutoryTimeframe24WeekHistory.get(0).getValue().getHomeOfficeCohort()).isEqualTo(SOME_HOME_OFFICE_COHORT);
    }
    ...
    void adds_a_stf_24_should_have_correct_case_type_and_status_at_case_level() {
        ...
        assertThat(response.getAsylumCase().read(STF_24W_HOME_OFFICE_COHORT).get()).isEqualTo(SOME_HOME_OFFICE_COHORT);
