...
import uk.gov.hmcts.reform.iacaseapi.domain.entities.Organisation;
...
@Slf4j
@Component
public class LegalRepresentativeBailDetailsAppender implements PreSubmitCallbackHandler<BailCase> {
    ...
    public LegalRepresentativeBailDetailsAppender(UserDetails userDetails, UserDetailsHelper userDetailsHelper,
