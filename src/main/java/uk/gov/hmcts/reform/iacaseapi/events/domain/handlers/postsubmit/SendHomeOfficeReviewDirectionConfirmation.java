...
@Component
public class SendHomeOfficeReviewDirectionConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callbackStage == CallbackStage.SUBMITTED
               && callback.getEventId() == EventId.SEND_HOME_OFFICE_REVIEW_DIRECTION;
    }
