...
@Component
public class ReviewCmaRequirementsConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return Event.REVIEW_CMA_REQUIREMENTS.equals(callback.getEvent());
    }
