...
@Component
public class SendDirectionWithQuestionsPreparer implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(PreSubmitCallbackStage callbackStage, Callback<AsylumCase> callback) {
        ...
        asylumCase.write(AsylumCaseFieldDefinition.SEND_DIRECTION_QUESTIONS, Collections.emptyList());
