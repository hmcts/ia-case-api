...
@Component
public class AllocateTheCaseResetOptionsHandler implements PreSubmitCallbackHandler<AsylumCase> {

    private final FeatureToggler featureToggler;

    public AllocateTheCaseResetOptionsHandler(FeatureToggler featureToggler) {
