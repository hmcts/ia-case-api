        ...
        mayBeApplyForCosts
            ...
            .forEach(applyForCostsIdValue -> {
                ...
                if (loggedUser.equals(applyForCosts.getApplyForCostsApplicantType())) {
                    applyForCosts.setApplicantAdditionalEvidence(evidenceDocuments.orElse(Collections.emptyList()));
                } else if (loggedUser.equals(applyForCosts.getApplyForCostsRespondentRole())) {
                    applyForCosts.setRespondentAdditionalEvidence(evidenceDocuments.orElse(Collections.emptyList()));
                }
            });
