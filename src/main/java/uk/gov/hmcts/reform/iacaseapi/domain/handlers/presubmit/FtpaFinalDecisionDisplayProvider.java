...
public class FtpaFinalDecisionDisplayProvider {
    ...
    private final String partiallyGranted = "partiallyGranted";
    private final String refused = "refused";
    private final String notAdmitted = "notAdmitted";
    private final String reheardRule35 = "reheardRule35";
    private final String reheardRule32 = "reheardRule32";
    private final String remadeRule32 = "remadeRule32";
    private final String appealDecision = "appealDecision";
