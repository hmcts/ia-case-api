...
@Component
public class GenerateAmendedHearingBundleConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callback.getEvent() == Event.GENERATE_AMENDED_HEARING_BUNDLE;
    }
    ...
    public PostSubmitCallbackResponse handle(Callback<AsylumCase> callback) {
        ...
        postSubmitResponse.setConfirmationHeader("# The amended hearing bundle is being generated");
