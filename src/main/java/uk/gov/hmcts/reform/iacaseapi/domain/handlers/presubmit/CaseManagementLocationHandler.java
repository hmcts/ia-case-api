...
@Component
@Slf4j
public class CaseManagementLocationHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(PreSubmitCallbackStage callbackStage,
        ...
        CaseManagementLocation caseManagementLocation = new CaseManagementLocation(Region.NATIONAL);
        asylumCase.write(AsylumCaseFieldDefinition.CASE_MANAGEMENT_LOCATION, caseManagementLocation);
