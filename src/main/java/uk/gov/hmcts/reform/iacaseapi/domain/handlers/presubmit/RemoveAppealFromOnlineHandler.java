...
@Component
public class RemoveAppealFromOnlineHandler implements PreSubmitCallbackHandler<AsylumCase> {

    private final DateProvider dateProvider;

    public RemoveAppealFromOnlineHandler(DateProvider dateProvider) {
