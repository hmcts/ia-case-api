...
@Component
public class CaseBuildingPaPayLaterDirectionHandler implements PreSubmitCallbackHandler<AsylumCase> {
    private final int paPayLaterDueDate;
    private final DateProvider dateProvider;
    private final DirectionAppender directionAppender;

    public CaseBuildingPaPayLaterDirectionHandler(
    ...
    public boolean canHandle(
        ...
        return callbackStage == PreSubmitCallbackStage.ABOUT_TO_SUBMIT
                && callback.getEvent().equals(Event.BUILD_CASE)
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        AsylumCase finalCase = HandlerUtils.feeDirectionReminder(asylumCase, directionAppender, dateProvider, paPayLaterDueDate, DirectionTag.CASE_BUILDING_PA_PAY_LATER, content);
