...
@Component
public class FtpaRespondentConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callback.getEvent() == Event.APPLY_FOR_FTPA_RESPONDENT;
    }
    ...
    public PostSubmitCallbackResponse handle(
        ...
        final Optional<YesOrNo> mayBeOutOfTime = caseData.read(AsylumCaseFieldDefinition.FTPA_RESPONDENT_SUBMISSION_OUT_OF_TIME, YesOrNo.class);
