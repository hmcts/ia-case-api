        ...
        switch (flagType) {
            ...
            case DETAINED_IMMIGRATION_APPEAL:
                additionalInfo = asylumCase.read(
                    CASE_FLAG_DETAINED_IMMIGRATION_APPEAL_ADDITIONAL_INFORMATION, String.class).orElse(null);
                asylumCase.write(FLAG_CASE_ADDITIONAL_INFORMATION, additionalInfo);
                break;
            case FOREIGN_NATIONAL_OFFENDER:
                additionalInfo = asylumCase.read(
                    CASE_FLAG_FOREIGN_NATIONAL_OFFENDER_ADDITIONAL_INFORMATION, String.class).orElse(null);
                asylumCase.write(FLAG_CASE_ADDITIONAL_INFORMATION, additionalInfo);
                break;
            case POTENTIALLY_VIOLENT_PERSON:
                additionalInfo = asylumCase.read(
                    CASE_FLAG_POTENTIALLY_VIOLENT_PERSON_ADDITIONAL_INFORMATION, String.class).orElse(null);
                asylumCase.write(FLAG_CASE_ADDITIONAL_INFORMATION, additionalInfo);
                break;
            case UNACCEPTABLE_CUSTOMER_BEHAVIOUR:
                additionalInfo = asylumCase.read(
                    CASE_FLAG_UNACCEPTABLE_CUSTOMER_BEHAVIOUR_ADDITIONAL_INFORMATION, String.class).orElse(null);
                asylumCase.write(FLAG_CASE_ADDITIONAL_INFORMATION, additionalInfo);
                break;
