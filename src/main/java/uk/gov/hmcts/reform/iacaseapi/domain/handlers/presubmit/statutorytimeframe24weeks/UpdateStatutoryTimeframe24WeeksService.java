...
public class UpdateStatutoryTimeframe24WeeksService {
    ...
    public AsylumCase updateAsylumCaseFromDetermination(AsylumCase asylumCase, YesOrNo stf24wStatus) {
        String stf24wReason = asylumCase.read(STF_24W_CURRENT_REASON_AUTO_GENERATED, String.class)
            .orElseThrow(() -> new IllegalStateException("stf24wCurrentReasonAutoGenerated is not present"));
