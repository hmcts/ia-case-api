...
public class UpdateStatutoryTimeframe24WeeksService {
    ...
    public AsylumCase updateAsylumCase(AsylumCase asylumCase, YesOrNo statutoryTimeframe24WeeksStatus) {
        ...
        YesOrNo currentStatus = asylumCase
                .read(STF_24W_CURRENT_STATUS_AUTO_GENERATED, YesOrNo.class)
                .orElseThrow(() -> new IllegalStateException("stf24wCurrentStatusAutoGenerated is not present"));

        boolean statusHasChanged = !currentStatus.equals(statutoryTimeframe24WeeksStatus);
        if (!statusHasChanged) {
        ...
        asylumCase.clear(STF_24W_CURRENT_STATUS_AUTO_GENERATED);
        asylumCase.clear(STATUTORY_TIMEFRAME_24_WEEKS);
