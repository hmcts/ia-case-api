...
public class UpdateStatutoryTimeframe24WeeksService {
    ...
    public AsylumCase updateAsylumCase(AsylumCase asylumCase, YesOrNo statutoryTimeframe24WeeksStatus) {
        ...
        boolean isStatusPresent = currentStatus.isPresent();
        boolean statusHasChanged = isStatusPresent && !currentStatus.get().equals(statutoryTimeframe24WeeksStatus);
        ...
        if (!isStatusPresent || statusHasChanged) {
            ...
            log.warn("The current 24-week status is already set to {}", statutoryTimeframe24WeeksStatus);
