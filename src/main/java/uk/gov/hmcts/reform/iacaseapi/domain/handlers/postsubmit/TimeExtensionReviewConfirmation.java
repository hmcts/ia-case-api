...
public class TimeExtensionReviewConfirmation implements CcdEventPostSubmitHandler<AsylumCase> {
    ...
    public CcdEventPostSubmitResponse handle(
        ...
        if (timeExtensionReview
            ...
            postSubmitResponse.setConfirmationHeader("# You have granted a time extension request");
        } else {
            postSubmitResponse.setConfirmationHeader("# You have denied a time extension request");
        }
