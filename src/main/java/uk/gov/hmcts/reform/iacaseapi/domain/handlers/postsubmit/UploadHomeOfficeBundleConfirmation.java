...
@Component
public class UploadHomeOfficeBundleConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callback.getEvent() == Event.UPLOAD_HOME_OFFICE_BUNDLE;
    }
