...
@Component
public class StartAppealRefNumberValidationMidEvent implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public StartAppealRefNumberValidationMidEvent(AppealReferenceNumberValidator appealReferenceNumberValidator) {
