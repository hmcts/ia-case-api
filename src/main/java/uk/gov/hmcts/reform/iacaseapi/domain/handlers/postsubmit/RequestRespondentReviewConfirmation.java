...
@Component
public class RequestRespondentReviewConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public PostSubmitCallbackResponse handle(
        ...
        final String hoRequestEvidenceInstructStatus =
            asylumCase.read(AsylumCaseFieldDefinition.HOME_OFFICE_REQUEST_REVIEW_INSTRUCT_STATUS, String.class).orElse("");
