...
@Component
public class DlrmSetAsideFeatureTogglePreparer implements PreSubmitCallbackHandler<AsylumCase> {

    private final FeatureToggler featureToggler;

    public DlrmSetAsideFeatureTogglePreparer(FeatureToggler featureToggler) {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        YesOrNo isDlrmSetAsideEnabled
            = featureToggler.getValue("dlrm-setaside-feature-flag", false) ? YES : NO;

        asylumCase.write(IS_DLRM_SET_ASIDE_ENABLED, isDlrmSetAsideEnabled);
