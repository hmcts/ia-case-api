...
@Component
public class RemoveStatutoryTimeframe24WeeksHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callbackStage.equals(ABOUT_TO_SUBMIT) && callback.getEvent().equals(REMOVE_STATUTORY_TIMEFRAME_24_WEEKS);
    }
