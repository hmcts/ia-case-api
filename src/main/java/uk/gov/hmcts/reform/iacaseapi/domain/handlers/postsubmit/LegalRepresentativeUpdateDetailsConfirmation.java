...
@Component
public class LegalRepresentativeUpdateDetailsConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callback.getEvent() == Event.UPDATE_LEGAL_REPRESENTATIVES_DETAILS;
    }
