...
@Slf4j
@Component
public class LegalRepresentativeCompanyNamePreparer implements PreSubmitCallbackHandler<AsylumCase> {
    private final CompanyNameProvider companyNameProvider;

    public LegalRepresentativeCompanyNamePreparer(CompanyNameProvider companyNameProvider) {
