...
import uk.gov.hmcts.reform.iacaseapi.domain.entities.Listing;
...
@Component
public class ListingUpdater implements CcdEventPreSubmitHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return stage == Stage.ABOUT_TO_SUBMIT
               && ccdEvent.getEventId() == EventId.RECORD_LISTING;
    }
