...
@Component
public class MarkEvidenceAsReviewedActionAvailableUpdater implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(
        ...
        if (Arrays.asList(
            ...
            asylumCase.write(MARK_EVIDENCE_AS_REVIEWED_ACTION_AVAILABLE, YesOrNo.NO);
        }
