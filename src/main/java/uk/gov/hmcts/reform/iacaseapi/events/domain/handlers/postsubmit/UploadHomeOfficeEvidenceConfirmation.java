...
@Component
public class UploadHomeOfficeEvidenceConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public PostSubmitCallbackResponse handle(
        ...
        String buildAppealDirectionUrl =
            "/case/" + callback.getCaseDetails().getJurisdiction() + "/Asylum/" + callback.getCaseDetails().getId() + "/trigger/sendBuildAppealDirection";
