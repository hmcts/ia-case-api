...
public class AriaCreateCaseHandler implements PreSubmitCallbackHandler<AsylumCase> {
    ...
    public PreSubmitCallbackResponse<AsylumCase> handle(PreSubmitCallbackStage callbackStage,
        ...
        String tribunalReceivedDate = asylumCase.read(TRIBUNAL_RECEIVED_DATE, String.class).orElse(dateProvider.now().toString());
        ...
        asylumCase.write(APPEAL_SUBMISSION_DATE, tribunalReceivedDate );
