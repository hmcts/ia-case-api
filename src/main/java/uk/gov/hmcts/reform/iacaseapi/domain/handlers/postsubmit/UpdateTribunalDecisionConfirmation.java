...
@Component
public class UpdateTribunalDecisionConfirmation implements PostSubmitCallbackHandler<AsylumCase> {
    ...
    public boolean canHandle(
        ...
        return callback.getEvent() == Event.UPDATE_TRIBUNAL_DECISION;
    }
