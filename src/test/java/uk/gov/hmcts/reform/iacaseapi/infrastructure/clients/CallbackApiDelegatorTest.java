...
class CallbackApiDelegatorTest {
    ...
    void should_call_document_api_to_generate_document() {
        ...
        final AsylumCase actualAsylumCase = callbackApiDelegator.delegate(callback, ENDPOINT);
    ...
    void should_call_notifications_api_to_send_notifications_in_ccd_submitted() {
        ...
        final PostSubmitCallbackResponse actualPostSubmitCallbackResponse = callbackApiDelegator.delegatePostSubmit(callback, ENDPOINT);
    ...
    void should_not_allow_null_arguments() {
        ...
        assertThatThrownBy(() -> callbackApiDelegator.delegate(null, ENDPOINT))
            .hasMessage("callback must not be null")
            .isExactlyInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> callbackApiDelegator.delegate(callback, null))
    ...
    void should_not_allow_null_arguments_for_post_submitted() {
        ...
        assertThatThrownBy(() -> callbackApiDelegator.delegatePostSubmit(null, ENDPOINT))
            .hasMessage("callback must not be null")
            .isExactlyInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> callbackApiDelegator.delegatePostSubmit(callback, null))
            .hasMessage("endpoint must not be null")
            .isExactlyInstanceOf(NullPointerException.class);
    }
    ...
    void wraps_http_server_exception_when_calling_documents_api() {
        ...
        assertThatThrownBy(() -> callbackApiDelegator.delegate(callback, ENDPOINT))
    ...
    void wraps_http_client_exception_when_calling_notifications_api() {
        ...
        assertThatThrownBy(() -> callbackApiDelegator.delegatePostSubmit(callback, ENDPOINT))
            .isExactlyInstanceOf(AsylumCaseServiceResponseException.class)
            .hasMessageContaining("Couldn't delegate callback to API")
            .hasCause(underlyingException);
    }
