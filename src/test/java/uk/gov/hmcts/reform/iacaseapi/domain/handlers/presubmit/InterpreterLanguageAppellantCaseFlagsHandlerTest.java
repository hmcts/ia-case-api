...
import static uk.gov.hmcts.reform.iacaseapi.domain.handlers.InterpreterLanguageAppellantCaseFlagsHandler.SPOKEN_INTERPRETER_CATEGORY;
...
public class InterpreterLanguageAppellantCaseFlagsHandlerTest {
    ...
    void should_set_interpreter_language_flag(Event event) {
        ...
        when(asylumCase.read(APPELLANT_INTERPRETER_LANGUAGE_CATEGORY, String.class)).thenReturn(Optional.of(SPOKEN_INTERPRETER_CATEGORY));
