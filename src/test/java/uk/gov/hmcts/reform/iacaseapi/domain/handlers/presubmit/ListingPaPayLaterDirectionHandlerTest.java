...
class ListingPaPayLaterDirectionHandlerTest {
    ...
    private ListingPaPayLaterDirectionHandler listingPaPayLaterDirectionHandler;
    ...
    void should_append_pay_later_direction() {
        ...
        PreSubmitCallbackResponse<AsylumCase> response =
                listingPaPayLaterDirectionHandler.handle(
                        PreSubmitCallbackStage.ABOUT_TO_SUBMIT,
                        callback
                );
    ...
    void handling_should_throw_if_cannot_actually_handle() {
        ...
        assertThatThrownBy(() -> listingPaPayLaterDirectionHandler
