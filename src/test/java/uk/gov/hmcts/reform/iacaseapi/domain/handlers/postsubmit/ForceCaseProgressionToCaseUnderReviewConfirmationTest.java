...
public class ForceCaseProgressionToCaseUnderReviewConfirmationTest {

    @Mock
    private Callback<AsylumCase> callback;

    private ForceCaseProgressionToCaseUnderReviewConfirmation forceCaseProgressionToCaseUnderReviewConfirmation = new ForceCaseProgressionToCaseUnderReviewConfirmation();
    ...
    public void should_return_confirmation() {
        ...
        assertThat(
            ...
            containsString("# You have forced the case progression to case under review")
        );
