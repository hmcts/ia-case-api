...
class ServiceHealthIndicatorTest {
    ...
    String serviceUpResponse = "{\"status\":\"UP\",\"components\":{\"db\":{\"status\":\"UP\"}}}";
    String serviceDownResponse = "{\"status\":\"DOWN\",\"components\":{\"db\":{\"status\":\"DOWN\"}}}";
    String statusUpServiceDown = "{\"status\":\"UP\",\"components\":{\"db\":{\"status\":\"DOWN\"}}}";
    String statusUnmatched = "{\"status\":\"UNKNOWN\",\"components\":{\"db\":{\"status\":\"UNKNOWN\"}}}";
