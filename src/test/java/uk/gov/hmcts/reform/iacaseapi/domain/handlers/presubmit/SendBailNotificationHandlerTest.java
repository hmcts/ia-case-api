...
class SendBailNotificationHandlerTest {
    ...
    public void setUp() {
        ...
        sendBailNotificationHandler =
            new uk.gov.hmcts.reform.iacaseapi.domain.handlers.presubmit.SendBailNotificationHandler(notificationSender, featureToggler);

        ReflectionTestUtils.setField(sendBailNotificationHandler, "isSaveAndContinueEnabled", true);
    ...
    void should_be_handled_at_latest_point() {
        assertEquals(DispatchPriority.LAST, sendBailNotificationHandler.getDispatchPriority());
    }
    ...
    void can_handle_payment_appeal_when_paid_aip_appeal() {
        ...
        assertTrue(sendBailNotificationHandler.canHandle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, callback));
    }
    ...
    void cannot_handle_payment_appeal_when_unpaid_aip_appeal() {
        ...
        assertFalse(sendBailNotificationHandler.canHandle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, callback));
    }
