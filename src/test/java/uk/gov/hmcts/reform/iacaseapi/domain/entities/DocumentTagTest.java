...
class DocumentTagTest {
    ...
    void has_correct_values() {
        ...
        assertEquals("reheardHearingNoticeListed", DocumentTag.REHEARD_HEARING_NOTICE_LISTED.toString());
        assertEquals("hearingNoticeListed", DocumentTag.HEARING_NOTICE_LISTED.toString());
