...
class PartyIdHandlerTest {
    ...
    void should_correctly_generate_party_ids_for_out_of_country_appeals(Event event) {
        ...
        PreSubmitCallbackResponse<AsylumCase> callbackResponse = partyIdHandler
        ...
        callbackResponse = partyIdHandler.handle(PreSubmitCallbackStage.ABOUT_TO_SUBMIT, callback);
        assertNotNull(callbackResponse);
        assertEquals(asylumCase, callbackResponse.getData());
