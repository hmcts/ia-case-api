...
class EditBailDocsAuditLogHandlerTest {
    ...
    @InjectMocks
    private uk.gov.hmcts.reform.iacaseapi.domain.handlers.postsubmit.editdocs.EditBailDocsAuditLogHandler editBailDocsAuditLogHandler;
    @Mock
    ...
    @Test
    void handle() {
        Logger fooLogger = (Logger) LoggerFactory.getLogger(uk.gov.hmcts.reform.iacaseapi.domain.handlers.postsubmit.editdocs.EditBailDocsAuditLogHandler.class);
