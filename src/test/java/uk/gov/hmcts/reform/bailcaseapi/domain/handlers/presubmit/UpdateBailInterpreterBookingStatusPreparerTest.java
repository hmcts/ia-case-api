...
import static uk.gov.hmcts.reform.iacaseapi.domain.entities.InterpreterBookingStatus.*;
...
class UpdateBailInterpreterBookingStatusPreparerTest {
    ...
    void should_set_applicant_interpreter_spoken_and_sign_booking_fields_if_required() {
        ...
        PreSubmitCallbackResponse<BailCase> response = updateBailInterpreterBookingStatusPreparer.handle(ABOUT_TO_START, callback);
    ...
    void it_can_handle_callback() {
        for (Event event : Event.values()) {
            ...
            for (PreSubmitCallbackStage callbackStage : PreSubmitCallbackStage.values()) {
                boolean canHandle = updateBailInterpreterBookingStatusPreparer.canHandle(callbackStage, callback);
    ...
    void handling_should_throw_if_cannot_actually_handle() {
        assertThatThrownBy(
            () -> updateBailInterpreterBookingStatusPreparer.handle(ABOUT_TO_SUBMIT, callback))
    ...
    void should_not_allow_null_arguments() {
        assertThatThrownBy(() -> updateBailInterpreterBookingStatusPreparer
