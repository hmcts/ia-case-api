...
class PartyIdHandlerTest {
    ...
    void handler_throws_error_if_cannot_actually_handle() {
        //invalid stage
        assertThatThrownBy(() -> partyIdHandler.handle(ABOUT_TO_START, callback)).hasMessage(
        ...
        assertThatThrownBy(() -> partyIdHandler.handle(ABOUT_TO_SUBMIT, callback)).hasMessage(
            "Cannot handle callback").isExactlyInstanceOf(IllegalStateException.class);
    }
}
