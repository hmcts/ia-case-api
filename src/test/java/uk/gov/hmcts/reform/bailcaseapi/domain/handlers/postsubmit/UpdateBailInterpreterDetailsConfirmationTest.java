...
class UpdateBailInterpreterDetailsConfirmationTest {
    ...
    private uk.gov.hmcts.reform.iacaseapi.domain.handlers.postsubmit.UpdateBailInterpreterDetailsConfirmation updateBailInterpreterDetailsConfirmation;

    @BeforeEach
    public void setUp() {
        updateBailInterpreterDetailsConfirmation = new uk.gov.hmcts.reform.iacaseapi.domain.handlers.postsubmit.UpdateBailInterpreterDetailsConfirmation();
    ...
    void should_return_confirmation_header_and_body() {
        ...
        PostSubmitCallbackResponse callbackResponse =
            updateBailInterpreterDetailsConfirmation.handle(callback);
    ...
    void should_not_allow_null_args() {
        assertThatThrownBy(() -> updateBailInterpreterDetailsConfirmation.handle(null))
    ...
    void should_not_handle_invalid_callback() {
        ...
        assertThatThrownBy(() -> updateBailInterpreterDetailsConfirmation.handle(callback)).isExactlyInstanceOf(
    ...
    void should_return_confirmation_on_edit_application_save() {
        ...
        PostSubmitCallbackResponse response = updateBailInterpreterDetailsConfirmation.handle(callback);
