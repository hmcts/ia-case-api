...
import static uk.gov.hmcts.reform.bailcaseapi.domain.entities.DocumentTag.BAIL_SUMMARY;
...
class EditDocsAboutToSubmitHandlerTest {
    ...
    void handle(BailCase bailCase,
        ...
        PreSubmitCallbackResponse<BailCase> currentResult = editDocsAboutToSubmitHandler
